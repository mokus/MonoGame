...
namespace Microsoft.Xna.Framework
{
    ...
    {
        private BlackBerryGameWindow _view;
        ...
        public override bool VSyncEnabled
        {
            get
            {
                return _view.VSync == OpenTK.VSyncMode.On ? true : false;
            }
            
            set
            {
                _view.VSync = value ? OpenTK.VSyncMode.On : OpenTK.VSyncMode.Off;
            }
        }
		...
		public OpenTKGamePlatform(Game game)
            : base(game)
        {
			_view = new BlackBerryGameWindow();
            _view.Game = game;
            this.Window = (GameWindow)_view;
